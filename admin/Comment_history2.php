...
<body>
	...
	<div id="komentari">
		...
		<form method='post' action='insert_into_history2.php'>
		...
		<div id="posted_comments">
				...
				?>
									...
									<div id="result">
										...
										<a class="del" href="delete_history2.php?comment=<?php echo $row['comment'] ?>">Delete</a><br><hr>
										</td></tr>
									</div>
	...
	<div id="footer">
		...
		<a href="History of the Old world2.php"> Back to the previous page </a>
