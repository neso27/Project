...
<body>
	...
	<div id="komentari">
		...
		<form method='post' action='insert_into_legend2.php'>
		...
		<div id="posted_comments">
				...
				?>
					...
					<div id="result">
						...
						<a class="del" href="delete_legend2.php?comment=<?php echo $row['comment'] ?>">Delete</a><br><hr>
						</td></tr>
					</div>
	...
	<div id="footer">
		...
		<a href="Legend of the Knights2.php"> Back to the previous page </a>
