...
<body>
	...
	<div id="nav">
		...
		<ul>
			<li>  <a href="Home2.php" class="a"> &raquo; Home </a> </li>
	...
	<div class="form">
		...
		<label for="Coment" id="comment"><i class="fa fa-comment" aria-hidden="true"></i> Ask the question library </label>
	...
	<div   class="shadow">
		...
		<p>
			<a href="See_comment2.php"> See comments </a>
		</p>
