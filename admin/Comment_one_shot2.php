...
<body>
	...
	<div id="komentari">
		...
		<form method='post' action='insert_into_one_shot2.php'>
		...
		<div id="posted_comments">
				...
				?>
									...
									<div id="result">
										...
										<a class="del" href="delete_one_shot2.php?comment=<?php echo $row['comment'] ?>">Delete</a><br><hr>
										</td></tr>
									</div>
	...
	<div id="footer">
		...
		<a href="One shot2.php"> Back to the previous page </a>
