...
<body>
	...
	<div id="komentari">
		...
		<form method="post" action="insert_into_comments_admin.php">
	...
	<div id="posted_comments">
				...
				?>
					...
					<div id="result">
						...
						<a class="del" href="delete_comment_admin.php?comment=<?php echo $row['comment'] ?>">Delete</a><br><hr>
						</td></tr>
					</div>
	...
	<div id="footer">
		...
		<a href="Children's books2.php"> Back to the previous page </a>
