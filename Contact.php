...
<body>
	...
	<div id="nav">
		...
		<ul>
			<li>  <a href="Home.php" class="a"> &raquo; Home </a> </li>
	...
	<div class="form">
		...
		<label for="comment" id="comment"><i class="fa fa-comment" aria-hidden="true"></i> Ask the question library </label>
	...
	<div   class="shadow">
		...
		<p>
			<a href="See_comment.php"> See comments </a>
		</p>
