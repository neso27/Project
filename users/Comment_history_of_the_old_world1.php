...
<body>
	...
	<div id="komentari">
		...
		<form method='post' action='insert_into_history_of_the_old_world1.php'>
		...
		<div id="posted_comments">
				...
				?>
									...
									<div id="result">
										...
										<a class="del" href="delete_history_of_the_old_world1.php?comment=<?php echo $row['comment'] ?>">Delete</a><br><hr>
										</td></tr>
									</div>
	...
	<div id="footer">
		...
		<a href="History of the Old World1.php"> Back to the previous page </a>
