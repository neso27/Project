...
<body>
	...
	<div id="komentari">
		...
		<form method='post' action='insert_into_storm_rampage1.php'>
		...
		<div id="posted_comments">
				...
				?>
									...
									<div id="result">
										...
										<a class="del" href="delete_storm_rampage1.php?comment=<?php echo $row['comment'] ?>">Delete</a><br><hr>
										</td></tr>
									</div>
	...
	<div id="footer">
		...
		<a href="Storm rampage1.php"> Back to the previous page </a>
