...
<body>
	...
	<div id="komentari">
		...
		<form method='post' action='Insert_into_angel_flight1.php'>
		...
		<div id="posted_comments">
				...
				?>
									...
									<div id="result">
										...
										<a class="del" href="delete_angel_flight1.php?comment=<?php echo $row['comment'] ?>">Delete</a><br><hr>
										</td></tr>
									</div>
	...
	<div id="footer">
		...
		<a href="Angel flight1.php"> Back to the previous page </a>
